      ...
      content={
        <>
          ...
          <View
            ...
            <Text style={{fontWeight: 'bold'}}>
              Siparişi nasıl silebilirim ?
            </Text>
            <Text style={{marginTop: 10}}>
              Sipariş listesi ekranındaki siparişi sil butonuna tıkladığınızda
              size siparişi silmek istediğinize dair bir uyarı gelecektir. Sil
              butonuna tıkladığınızda sipariş silinir.
            </Text>
          </View>
        </>
      }
